...
function addTodo(event){
    ...
    //CLEAR TODO INPUT VALUE (after/before something has been typed)
    todoInput.value = "";
}
...
function saveLocalTodos(todo){
    //CHECK IF ALREADY HAVE STORED TODO's
    let todos;
...
function getTodos(){
    ...
    todos.forEach(function(todos){
        ...
        //Create LI
        const newTodo = document.createElement("li");
        newTodo.innerText = todos; //receive old list and add it to list.
        newTodo.classList.add("todo-item");
        todoDiv.appendChild(newTodo);
